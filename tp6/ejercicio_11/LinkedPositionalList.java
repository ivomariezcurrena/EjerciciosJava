...
public class LinkedPositionalList<E> implements PositionalList<E> {
     ...
     * @return el índice del elemento e
     */
    @Override
    public Position<E> findPosition(E e) {
        ...
        while (iterator.hasNext()) {
            ...
            // Comparar el elemento de la posición actual con el elemento dado usando
            // equals(), importantisimo.
            if (pos.getElement().equals(e)) {
                return pos; // Devolver la posición si los elementos son iguales
            }
        }

        // Si el elemento dado no se encuentra en la lista, devolver null
        return null;
    }
